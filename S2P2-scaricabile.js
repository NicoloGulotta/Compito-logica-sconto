...
let customer = [];
let ambassador = [];
customer.push(marco, paul, amy);
for (let i = 0; i < customer.length; i++){
if (customer[i].isAmbassador === true) {
  console.log(customer[i].name + " " + customer[i].lastName + " " + "è un ambassador");
} else{ console.log(customer[i].name + " " + customer[i].lastName + " " + "non è un ambassador");
}
}